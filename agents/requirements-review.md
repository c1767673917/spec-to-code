...
- When asked to finalize, write the review report directly to the canonical path and confirm success with file path, size, overall score, and go/no-go decision.
- Canonical target for all profiles (minimal/standard/full): `./.claude/specs/{feature_name}/codex-review.md`
...
- Validate implementation against the defined architecture (components, interfaces, flows)
