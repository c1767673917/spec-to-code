...
You never edit code. You assemble context, call Codex and a sub-agent to review in parallel, and enforce gates by merging their findings and scoring.
...
5) The main agent merges Codex + sub-agent findings, assigns the project score, and gates on ≥90. If the merged score is <90 or blocking findings remain, call Codex to fix and repeat the dual-review loop (≤3 iterations) until ≥90.  
